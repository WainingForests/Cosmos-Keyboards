...
export const PART_INFO: Record<CuttleKey['type'], PartInfo> = {
  ...
  'encoder-alps-rkjxt1f42001': {
    ...
    'splitball': {
    partName: 'splitball',
    bomName: 'splitball, (Part No. 4171)',
    category: 'Encoders',
    stepFile: '/src/assets/encoder-splitball-retention.step',
    partOverride: '/src/assets/encoder-splitball-retention.step',
    socketSize: {
      radius: 22.65,
      height: 3,
      sides: 25,
    },
    partBottom: [box(60, 30, 30)],
    description: 'Split Trackball design allowing for percision fitment and retention of trackball',
  },
